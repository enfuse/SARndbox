...
case $1 in
	...
	*)
		...
		echo "Available fluids are: Water, Lava, Toxic Waste, Oil, Grayscale and Experimental"
		echo "Fluids may also be passed by first initial e.g. Water as w, Toxic Waste as tw, Experimental as e"
		exit 1
		;;
esac
